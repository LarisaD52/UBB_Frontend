...
export default function ConsumeProfileScreen() {
  ...
  const [modalType, setModalType] = useState<"furnizor" | "categorie">(
    "categorie",
  );
  ...
  const addItem = () => {
    if (newItemName.trim().length > 0) {
      ...
      const newItem = {
        ...
        desc:
          modalType === "furnizor"
            ? "Furnizor adăugat manual"
            : "Categorie adăugată manual",
        icon: "basket",
        active: true,
        isCustom: true,
      };
      ...
      >
        <View style={styles.infoBox}>
          ...
          <Text style={styles.infoText}>
            Personalizează ce monitorizează Sento. Poți opri monitorizarea sau
            șterge definitiv categoriile noi.
          </Text>
        </View>
        ...
        <TouchableOpacity style={styles.saveBtn} onPress={saveRestrictions}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              {modalType === "furnizor"
                ? "Adaugă furnizor"
                : "Ce să mai monitorizeze Sento?"}
            </Text>
            <TextInput
              style={styles.input}
              placeholder={
                modalType === "furnizor"
                  ? "Scrie aici numele furnizorului (ex: SRL Medlife)"
                  : "Scrie aici (ex: Fast Food)"
              }
              value={newItemName}
